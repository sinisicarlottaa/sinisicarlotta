...
export class WorkComponent {
  works: WorkItem[] = [
    ...
    },
    {
      ...
      company: 'VLC² / Reply / Intesa Sanpaolo',
      ...
      description: {
        ...
        body: 'I contribute to the development and maintenance of web interfaces using Angular and JavaScript, collaborating within a structured team.',
        outro:
